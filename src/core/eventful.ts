// Event listeners may return a boolean to indicate the event propagation should stop
export type EventListener = ((any) => boolean) | ((any) => void)
...
export class Eventful {
   ...
   */
  addEventListener (eventName: string, callback: EventListener): Eventful {
   ...
   */
  getEventListeners (eventName: string): EventListener[] {
   ...
   */
  hasEventListenersFor (eventName: string): boolean {
   ...
   */
  removeEventListener (eventName: string, callback: EventListener): Eventful {
    if (Array.isArray(callback)) {
   ...
   * @returns {Eventful} Returns self (for chaining)
   */
  removeEventListeners (eventName: string): Eventful {
   ...
   */
  triggerEvent (eventName: string, data: any): boolean {
